        ...
        <div className="w-full rounded-3xl border border-border/80 bg-white pt-10 pb-6 px-8 md:px-12 shadow-sm">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mb-12">
            ...
            <div className="col-span-1 md:col-span-3">
              ...
              <ul className="space-y-4">
                ...
                <li><Link href="/login" className="text-[13px] text-muted-foreground hover:text-primary transition-colors">Login</Link></li>
            ...
            <div className="col-span-1 md:col-span-4">
              ...
              <ul className="space-y-4">
                <li className="flex items-center gap-3">
                  ...
                  <span className="text-[13px] text-muted-foreground">9354610893</span>
                </li>
                <li className="flex items-start gap-3">
                  <MapPin className="h-4 w-4 text-muted-foreground mt-[2px] shrink-0" strokeWidth={2} />
                  <span className="text-[13px] text-muted-foreground leading-relaxed">DTU IIF AB-4 ,Shahbad ,<br />Rohini , Delhi , 110042</span>
                </li>
                <li className="flex items-center gap-3">
                  <Mail className="h-4 w-4 text-muted-foreground shrink-0" strokeWidth={2} />
                  <span className="text-[13px] text-muted-foreground">librarynear.com@gmail.com</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between border-t border-border pt-6">
            <p className="text-[12px] text-muted-foreground/80 text-center md:text-left mb-4 md:mb-0 max-w-lg">
              ©2026 Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
            </p>
            <div className="flex items-center gap-3">
              <Link href="#" className="h-[30px] w-[30px] rounded bg-sky-50 flex items-center justify-center text-primary/80 hover:bg-primary/10 transition-colors">
