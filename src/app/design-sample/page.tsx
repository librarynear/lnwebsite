            ...
            {mockPlans.map((plan) => {
              ...
              return (
                <div key={`stacked-${plan.id}`} className="flex flex-row bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-md hover:border-blue-400 active:scale-[0.99] active:bg-slate-50/50 transition-all duration-200 cursor-pointer overflow-hidden group relative">
                  ...
                  {/* Left Side: Clean Typography */}
                  <div className="flex-1 py-3 pr-3 pl-4 sm:py-6 sm:pr-6 sm:pl-8 flex flex-col justify-center relative min-w-0">
                    {/* Subtle hover gradient */}
                    ...
                    <div className="relative z-10">
                      ...
                      {/* Details row */}
                      <div className="flex flex-row items-center gap-x-2 sm:gap-x-4 gap-y-2 mt-2 sm:mt-3 overflow-hidden">
                  ...
                  {/* Right Side: Price Block */}
                  <div className="py-3 pr-4 pl-3 sm:py-6 sm:pr-6 sm:pl-6 w-[125px] sm:w-[220px] bg-slate-50/50 flex flex-col justify-center items-end relative z-10 group-active:bg-slate-100/50 transition-colors flex-shrink-0">
                    <div className="text-right">
                      ...
                      <div className="text-[9px] sm:text-[12px] font-medium text-slate-400 leading-tight whitespace-nowrap">
                        Total ₹{finalPrice.toFixed(0)} 
                        {plan.discount > 0 && (
