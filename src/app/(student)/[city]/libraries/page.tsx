...
export async function generateMetadata(props: any): Promise<Metadata> {
  ...
  return {
    title: `Best Study Libraries in ${city} | FocusDesk`,
    ...
    openGraph: {
      ...
      url: `https://www.focusdesk.in/${params.city}/libraries`,
    }
  }
}
...
export default async function CityLibrariesPage(props: any) {
  ...
  const cacheKey = `libraries:city:${cityName}:search:${query}`;
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="container mx-auto px-6 md:px-10 py-10 pb-20">
        <div className="flex items-center justify-between mb-8">
          ...
          {query && (
            <Link href={`/${params.city}/libraries`} className="text-sm text-primary font-medium hover:underline">
              Clear all
            </Link>
          )}
        </div>
