...
export const metadata: Metadata = {
  title: "About Us | FocusX",
  description: "Learn more about FocusX, India's premium platform to find, compare, and book study libraries and quiet spaces for uninterrupted focus.",
};
